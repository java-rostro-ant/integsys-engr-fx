...
package org.rmj.integsys.engr.views.child;
...
public class FoodLedgerController implements Initializable {
    ...
    public void cmdButton_Click(ActionEvent event) {
     ...
     private void initGridLedger(){
        ...
        index01.setCellValueFactory(new PropertyValueFactory<org.rmj.integsys.engr.views.child.TableModel,String>("index01"));
        index02.setCellValueFactory(new PropertyValueFactory<org.rmj.integsys.engr.views.child.TableModel,String>("index02"));
        index03.setCellValueFactory(new PropertyValueFactory<org.rmj.integsys.engr.views.child.TableModel,String>("index03"));
        index04.setCellValueFactory(new PropertyValueFactory<org.rmj.integsys.engr.views.child.TableModel,String>("index04"));
        index05.setCellValueFactory(new PropertyValueFactory<org.rmj.integsys.engr.views.child.TableModel,String>("index05"));
        index06.setCellValueFactory(new PropertyValueFactory<org.rmj.integsys.engr.views.child.TableModel,String>("index06"));
